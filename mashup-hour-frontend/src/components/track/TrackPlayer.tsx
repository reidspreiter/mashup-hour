    ...
    return (
        <section>
            ...
            <div className="main-column-section">
                ...
                <Casing sub2={<SimpleSwitch name="end-relative reverse" onClick={() => { }} />}><Switch name="reverse" icon={IoArrowBackSharp} onClick={(isEnabled: boolean) => player.reverse = isEnabled} /></Casing>

    ...
    return (
        <section>
            ...
            <div className="main-column-section">
                ...
                <Casing sub2={<SimpleSwitch name="reverse relative to end" onClick={() => { }} />}><Switch name="reverse" icon={IoArrowBackSharp} onClick={(isEnabled: boolean) => player.reverse = isEnabled} /></Casing>
                <Casing sub1={<SimpleButton name="restart" onClick={player.restart} />} sub2={<SimpleSwitch name="restart on pause" onClick={(isEnabled: boolean) => player.restartOnPause = isEnabled} />}><PlayButton onClick={player.togglePlayer} isPlaying={isPlaying} setIsPlaying={setIsPlaying} /></Casing>
                <Casing sub1={<SimpleButton name="randomize playbar bounds" onClick={player.randomizeBounds} />} sub2={<SimpleButton name="randomize bound position" onClick={player.randomizeBoundPosition} />}><Switch name="loop" icon={IoRepeatSharp} onClick={(isEnabled: boolean) => player.loop = isEnabled} /></Casing>
